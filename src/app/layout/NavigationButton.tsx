...
export const NavigationButton = ({
  ...
  baseClassName = 'w-full flex items-center gap-2 px-4 py-3 rounded-lg transition-all duration-300 ease-out font-medium text-left cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] hover:shadow-md',
