...
export const HorizontalScroll: React.FC<HorizontalScrollProps> = ({
  ...
  return (
    <div className={`relative ${className || ''}`}>
      <div
        ref={containerRef}
        className="no-scrollbar overflow-x-auto overflow-y-hidden -mx-4 px-4 scroll-smooth"
      ...
      {hasOverflow && (
        <>
          <button
            ...
            className={`hidden lg:flex items-center justify-center absolute left-1 top-1/2 -translate-y-1/2 rounded-full bg-black/50 hover:bg-black/70 text-white w-9 h-9 shadow-md transition-opacity ${
          ...
          <button
            ...
            className={`hidden lg:flex items-center justify-center absolute right-1 top-1/2 -translate-y-1/2 rounded-full bg-black/50 hover:bg-black/70 text-white w-9 h-9 shadow-md transition-opacity ${
